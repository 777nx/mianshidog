package com.fantasy.mianshidog.service.impl;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.fantasy.mianshidog.common.ErrorCode;
import com.fantasy.mianshidog.constant.CommonConstant;
import com.fantasy.mianshidog.exception.BusinessException;
import com.fantasy.mianshidog.exception.ThrowUtils;
import com.fantasy.mianshidog.manager.AiManager;
import com.fantasy.mianshidog.model.dto.mockinterview.MockInterviewAddRequest;
import com.fantasy.mianshidog.model.dto.mockinterview.MockInterviewChatMessage;
import com.fantasy.mianshidog.model.dto.mockinterview.MockInterviewEventRequest;
import com.fantasy.mianshidog.model.dto.mockinterview.MockInterviewQueryRequest;
import com.fantasy.mianshidog.model.entity.MockInterview;
import com.fantasy.mianshidog.model.entity.User;
import com.fantasy.mianshidog.model.enums.MockInterviewEventEnum;
import com.fantasy.mianshidog.model.enums.MockInterviewStatusEnum;
import com.fantasy.mianshidog.service.MockInterviewService;
import com.fantasy.mianshidog.mapper.MockInterviewMapper;
import com.fantasy.mianshidog.utils.SqlUtils;
 ...
 * @createDate 2025-11-02 13:58:48
 */
@Service
public class MockInterviewServiceImpl extends ServiceImpl<MockInterviewMapper, MockInterview>
    ...
    public Long createMockInterview(MockInterviewAddRequest mockInterviewAddRequest, User loginUser) {
        ...
        ThrowUtils.throwIf(StrUtil.hasBlank(workExperience, jobPosition, difficulty), ErrorCode.PARAMS_ERROR, "参数为空");
        // 2. 封装插入到数据库中的对象
